...
def siapa():
	...
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mSelamat datang di tools Cyber Limit \033[1;92m" +nama+ "\n\033[1;97mTerimakasih telah menggunakan tools ini !!")
		time.sleep(3)
		loginSC()
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/Cyber Limit')
				menu()
			except requests.exceptions.ConnectionError:
				print"\n\033[1;96m[!] \x1b[1;91mTidak ada koneksi"
				keluar()
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mAkun lu kena checkpoint bego\n\tJangan salahin admin salahin akun lu\n\tKARNA MEMBUAT GA SEGAMPANG MEMAKAI")
